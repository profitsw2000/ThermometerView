...
import ru.profitsw2000.data.domain.filter.SensorHistoryFilterRepository
...
val memoryModule = module{
    ...
    single<SensorHistoryTableFilterRepository> { SensorHistoryTableFilterRepositoryImpl() }
    single<SensorHistoryRepositoryLocal> { SensorHistoryRepositoryLocalImpl(get(), get(), get(), get()) }
